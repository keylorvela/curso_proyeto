...
exports.mailTemplate_FormVerification = exports.mailTemplate_UserRegistration = exports.mailTemplate_OTP = void 0;
...
const mailTemplate_FormVerification = (name, phoneNumber, email, courseName, courseSchedule) => {
    ...
    <body>
        ...
        <div class="content_container">
            ...
            <p class="montserrat-text p_content">
                Si tiene alguna pregunta o necesita asistencia adicional, no dude en comunicarse con nosotros al siguiente número de contacto [Número de teléfono].
            </p>
            <p class="montserrat-text p_content">
                Saludos cordiales.
            </p>
