...
exports.mailTemplate_ApplicationRejected = exports.mailTemplate_FormVerification = exports.mailTemplate_UserRegistration = exports.mailTemplate_OTP = void 0;
...
const mailTemplate_FormVerification = (name, phoneNumber, email, courseName, courseSchedule) => {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
exports.mailTemplate_FormVerification = mailTemplate_FormVerification;
const mailTemplate_ApplicationRejected = (name) => {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
exports.mailTemplate_ApplicationRejected = mailTemplate_ApplicationRejected;
