export const mailTemplate_OTP = (OTP: string, name: string) => {
    ...
    <body>
        ...
        <div class="content_container">
            ...
            <p class="montserrat-text p_content">
                Si tienes alguna pregunta o necesitas ayuda, no dudes en ponerte en contacto con nuestro equipo de soporte a través del Whatsapp https://wa.me/50661286160 o el número de teléfono +506 6128-6160.
            </p>
            <p class="montserrat-text p_content">
                Saludos cordiales.
            </p>
